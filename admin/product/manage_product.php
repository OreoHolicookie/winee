...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
			...
			<div class="form-group">
				<label for="title" class="control-label">Wine</label>
                <textarea name="title" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
			</div>
			<div class="form-group">
            <label for="author" class="control-label">Producer</label>
                <small>(<i>Use comma (,) for seperating the name of Producer</i>)</small>
