...
Class Master extends DBConnection {
	...
	function save_product(){
		...
		if($save){
			...
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"New Wine successfully saved.");
			else
				$this->settings->set_flashdata('success',"Wine successfully updated.");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
